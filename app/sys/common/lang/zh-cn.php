...
$lang->ranzhi    = 'HYGGE & ARCHIFOR ';
$lang->agreement = "已阅读并同意<a href='http://zpl.pub/page/zplv12.html' target='_blank'>《Z PUBLIC LICENSE授权协议1.2》</a>。<span class='text-danger'>未经许可，不得去除、隐藏或遮掩该系统的任何标志及链接。</span>";
$lang->poweredBy = "<a href='https://www.hygge-art.com' target='_blank'>{$lang->ranzhi}%s</a>";
